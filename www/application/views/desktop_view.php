...
<title>MyrmeCore Desktop</title>

    <link rel="stylesheet" type="text/css" href="desktop/js/resources/css/ext-all.css" />
    ...
    <script type="text/javascript" src="desktop/myrmecore.js"></script>
</head>
<body scroll="no">
<div id="x-desktop">
